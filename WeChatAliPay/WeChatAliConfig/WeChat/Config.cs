    ...
    */
    ...
    {  
        ...
        */
        ...
        public static string WeChatPayAPIKey {get;set;}
        public static string APPSECRET  {get;set;}
        public static string WeChatMicroPayUrl { get; set; }
        public static string WeChatOrderQueryUrl { get; set; }
        public static string WeChatCloseOrderUrl {get;set;}
